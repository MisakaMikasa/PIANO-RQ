...
def test_main(num_nodes):
    ...
    if os.path.exists('./New Graph Dataset/DDPG_agent(p2p1_3c2).pth'):
        print("Loading pre-trained agent...")
        checkpoint = torch.load('./New Graph Dataset/DDPG_agent(p2p1_3c2).pth')
